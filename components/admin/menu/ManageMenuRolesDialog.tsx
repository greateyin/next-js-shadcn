...
/**
 * ManageMenuRolesDialog Props
 */
interface ManageMenuRolesDialogProps {
  open: boolean;
...
export function ManageMenuRolesDialog({
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      console.error("[MANAGE_MENU_ROLES]", error);
      ...
      <DialogContent className="sm:max-w-[550px] max-h-[90vh] overflow-y-auto bg-white border-gray-200/50">
        <DialogHeader>
          ...
          <DialogDescription className="text-gray-600">
            Select roles that can access "{menuItemName}"
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="flex gap-2 flex-wrap">
            ...
            <Button
              ...
              size="sm"
              onClick={
                searchQuery || filterMode !== "all" ? handleDeselectFiltered : handleDeselectAll
              }
              disabled={
                isSubmitting ||
